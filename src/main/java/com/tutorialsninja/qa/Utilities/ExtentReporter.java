...
public class ExtentReporter {
	...
	sparkReporter.config().setReportName("BootCamp Hybrid Framework Extent Report Results");
	sparkReporter.config().setDocumentTitle("TNReportTitle|BootCampShahriar");
